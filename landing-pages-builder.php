<?php
  ...
  */
  ...
  load_plugin_textdomain('landing-pages-builder', false, dirname(plugin_basename(__FILE__)) . '/lang/');
  ...
  new WishpondPlugin(
    array(
      ...
      'menu' => array(
        'main'      => __('Landing Pages', 'landing-pages-builder'),
        'dashboard' => __('Dashboard', 'landing-pages-builder'),
        'editor'    => __('New Landing Page', 'landing-pages-builder'),
        'settings'  => __('Settings', 'landing-pages-builder')
      )
    )
  );
?>
